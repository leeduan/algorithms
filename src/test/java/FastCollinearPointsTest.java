...
public class FastCollinearPointsTest {
    ...
    public void testSegmentsOnePoints() {
        ...
        assertTrue(new FastCollinearPoints(points).numberOfSegments() == 0);
    }
    ...
    @Test
    public void testSegmentsSixPoints() {
        ...
        assertTrue(new FastCollinearPoints(points).numberOfSegments() == 1);
    }
    ...
    public void testSegmentsEightPoints() {
        ...
        assertTrue(new FastCollinearPoints(points).numberOfSegments() == 2);
    }
    ...
    public void testSegmentsEquidistant() {
        ...
        assertTrue(new FastCollinearPoints(points).numberOfSegments() == 4);
    }
